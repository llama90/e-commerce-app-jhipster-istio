...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://store.jhipster.34.90.236.124.nip.io"
        echo "Zipkin - http://zipkin.istio-system.34.90.236.124.nip.io"
        echo "Grafana - http://grafana.istio-system.34.90.236.124.nip.io"
        echo "Kiali - http://kiali.istio-system.34.90.236.124.nip.io"
        echo "#####################################################"
}
